...
if __name__ == "__main__":
    fp = "0926ZakariyyaAnsari.AsnaMatalib.Shamela0011468-ara1"
    texts_d = {
        r"\A.*?(?=### \| \[حاشية)": {
            "fn": "0926ZakariyyaAnsari.AsnaMatalib.Shamela0011468BK1-ara1",
            "text": [],
            },
        r"(### \| \[حاشية .+?)(?=### \| \[حاشية|\Z)": {
            "fn": "0957ShihabDinRamli.HashiyaCalaAsnaMatalib.Shamela0011468BK2-ara1",
            "text": []
            },
